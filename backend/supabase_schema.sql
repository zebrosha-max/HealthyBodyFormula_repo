-- Supabase SQL Schema for HBF Food Logger & Body Progress
...
-- NOTE: Run these ALTER commands manually if table exists
...
create policy "Allow delete access for all" on public.water_logs for delete using (true);
